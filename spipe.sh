...
path2data="/data1/hania/MultiSpeciesComp/newvolume"
nohup split-pipe \
--mode mkref \
--genome_name GRCh38 \
...
sed -i -e 's/limitGenomeGenerateRAM 24000000000/limitGenomeGenerateRAM 41888514314/g' /home/hania/.local/lib/python3.10/site-packages/splitpipe/mkref.py
split-pipe \
--mode mkref \
